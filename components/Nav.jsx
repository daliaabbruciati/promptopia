/* I need to add 'use client' when I need to use some basic 
client side functionality, such as hooks, next-auth, etc. */ 
"use client"
...
const Nav = () => {
  ...
  /* Providers is an object with all the providers related to Auth, for example Google, Github, etc. */
